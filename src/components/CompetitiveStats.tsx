  ...
  const platformsWithInfo = [
    {
      ...
      color: '#FFA116',
      username: 'dubugmylife',
      url: 'https://leetcode.com/debugmylife/',
      rating: "1500",
      data: leetcodeData,
      problems: "250 problems solved"
    },
    {
      name: "Codeforces",
      icon: <LineChart className="w-6 h-6 text-[#318CE7]" />,
      color: '#318CE7',
      username: 'harshsharma1501',
      url: 'https://codeforces.com/profile/harshsharma1501',
      rating: "1000",
      data: codeforcesData,
      problems: "Highest: 1100"
    },
    {
      name: "CodeChef",
      icon: <Award className="w-6 h-6 text-[#9C7A2E]" />,
      color: '#9C7A2E',
      username: 'debugmylife',
      url: 'https://www.codechef.com/users/debugmylife',
      rating: "1400",
      data: codechefData,
      problems: "Best Rank: 2500"
    }
  ];
